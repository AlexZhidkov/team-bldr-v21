...
${msgIdle}`, { headers: this.adapter.newHeaders({ 'Content-Type': 'text/plain' }) });
    ...
    class Driver {
        constructor(scope, adapter, db) {
            ...
            // Custom Team Builder Events
            this.scope.addEventListener('team-bldr-accepted', (event) => {
                var notification = event.notification;
                console.log('action team-bldr-accepted');
                clients.openWindow('https://team-bldr.web.app/yes/');
            });
            this.scope.addEventListener('team-bldr-rejected', (event) => {
                var notification = event.notification;
                console.log('action team-bldr-rejected');
                clients.openWindow('https://team-bldr.web.app/no/');
            });
            this.scope.addEventListener('team-bldr-message', (event) => {
                var notification = event.notification;
                console.log('action team-bldr-message');
                clients.openWindow('https://team-bldr.web.app/');
            });
        ...
        handleClick(notification, action) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                // Code from https://medium.com/kabbage-engineering/angular-pwa-app-notification-using-firebase-cloud-messaging-d1b7bd171b98
